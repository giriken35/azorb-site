    ...
    <main className="mx-auto min-h-screen w-full max-w-[1500px] px-4 py-8 sm:px-6 lg:px-8">
      ...
      <section id="products" className="mb-24 scroll-mt-24 rounded-3xl border border-border bg-card/40 p-6 sm:p-12 backdrop-blur-sm shadow-sm">
        ...
        <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
          ...
          <div className="group flex flex-col overflow-hidden rounded-2xl border-[3px] border-border bg-surface transition-all duration-100 ease-out hover:border-emerald-500/50 hover:shadow-xl hover:-translate-y-1">
            <div className="relative aspect-video w-full overflow-hidden bg-muted/30 border-b border-border/50 p-2">
              <img 
                ...
                className="w-full h-full object-cover rounded-xl transition-transform duration-100 ease-out group-hover:scale-105"
              />
            </div>
          ...
          <div className="group flex flex-col overflow-hidden rounded-2xl border-[3px] border-border bg-surface transition-all duration-100 ease-out hover:border-brand/50 hover:shadow-xl hover:-translate-y-1">
            <div className="relative aspect-video w-full overflow-hidden bg-muted/30 border-b border-border/50 p-2">
              <img 
          ...
          <div className="group flex flex-col overflow-hidden rounded-2xl border-[3px] border-border bg-surface transition-all duration-100 ease-out hover:border-fuchsia-500/50 hover:shadow-xl hover:-translate-y-1">
            <div className="relative aspect-video w-full overflow-hidden bg-muted/30 border-b border-border/50 p-2">
              <img 
          ...
          <div className="group flex flex-col overflow-hidden rounded-2xl border-[3px] border-border bg-surface transition-all duration-100 ease-out hover:border-blue-500/50 hover:shadow-xl hover:-translate-y-1">
            <div className="relative aspect-video w-full overflow-hidden bg-muted/30 border-b border-border/50 p-2">
              <img 
                src="/local-news-screenshot.png" 
                alt="自分専用 広告なし地元ニュースサイト" 
                className="w-full h-full object-cover object-top rounded-xl transition-transform duration-100 ease-out group-hover:scale-105"
              />
            </div>
            <div className="flex flex-1 flex-col p-6 sm:p-8">
              <div className="mb-4 flex flex-wrap gap-2">
          ...
          <div className="group flex flex-col overflow-hidden rounded-2xl border-[3px] border-border bg-surface transition-all duration-100 ease-out hover:border-orange-500/50 hover:shadow-xl hover:-translate-y-1">
            <div className="relative aspect-video w-full overflow-hidden bg-muted/30 border-b border-border/50 p-2">
              <img 
      ...
      <section id="focus" className="mb-24 scroll-mt-24">
        ...
        <div className="grid gap-6 sm:grid-cols-3">
          <div className="group relative overflow-hidden rounded-2xl border-[3px] border-border bg-card p-6 sm:p-8 transition-all duration-100 ease-out hover:border-brand/50 hover:shadow-xl hover:-translate-y-1">
          ...
          <div className="group relative overflow-hidden rounded-2xl border-[3px] border-border bg-card p-6 sm:p-8 transition-all duration-100 ease-out hover:border-brand-2/50 hover:shadow-xl hover:-translate-y-1">
          ...
          <div className="group relative overflow-hidden rounded-2xl border-[3px] border-border bg-card p-6 sm:p-8 transition-all duration-100 ease-out hover:border-orange-500/50 hover:shadow-xl hover:-translate-y-1">
