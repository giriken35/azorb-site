export const en = {
  header: {
    products: "Products",
    focus: "Focus Areas",
    toast: "Page refreshed successfully"
  },
  hero: {
    furigana: "Azorb",
    badge: "Independent Product Studio",
    title1: "Pinpoint tools for",
    title2: "niche challenges.",
    desc1: "From resolving those granular workflow bottlenecks that giant corporations ignore,",
    desc2: "to playful web apps that add a spark of humor to your daily life.",
    desc3: "With the unmatched agility and cost-effectiveness of an independent studio,",
    desc4: "we deploy products that scratch the exact itch you didn't know you had."
  },
  products: {
    title: "Products",
    subtitle: "Active & Upcoming Projects",
    p1: {
      b1: "Next.js Template", b2: "In Development",
      t: "Modern UI Boilerplate for SaaS",
      d: "A commercially viable Next.js template featuring sophisticated glassmorphism design and high-speed performance. We slash UI implementation costs for developers at a low price point only possible through an indie studio.",
      cta: "Coming Soon"
    },
    p2: {
      b1: "SaaS", b2: "Free Beta",
      t: "Address Data Normalizer",
      d: "A browser-based tool that instantly standardizes chaotic address data (from Excel, etc.) and auto-completes latitude/longitude. Eradicate manual data-cleansing and dramatically improve operational efficiency.",
      cta: "Launch App"
    },
    p3: {
  ...
  focus: {
    ...
    f2: {
      ...
      d: "By eliminating sales overhead and middleman margins, we leverage the ultimate strength of an indie developer to provide enterprise-grade modern tools at highly accessible prices."
    },
    f3: {
      t: "Playfulness & Humor",
      d: "Beyond sterile business efficiency, we develop idea-driven tools designed to make you smirk. We highly value digital experiences that add a little spice to your everyday routine."
    }
  },
  poweredBy: {
    title: "Powered by",
    ...
    note: "* The implementation of the Languages / Frameworks and Infrastructure listed above is heavily augmented by AI and AI agents."
  },
  about: {
    title: "About Studio",
    ...
    v1: "Azorb",
    l2: "Business Domain",
    v2_1: "Planning & development of Micro-SaaS, AI, and automation apps",
